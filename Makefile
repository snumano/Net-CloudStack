# This Makefile is for the Net::CloudStack extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/CloudStack.pm]
#     AUTHOR => [q[Shugo Numano <numano@cc.rim.or.jp>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Net::CloudStack]
#     PL_FILES => {  }
#     PREREQ_PM => { XML::Twig=>q[0], XML::Simple=>q[0], Encode=>q[0], Carp=>q[0], URI::Encode=>q[0], Test::More=>q[0], LWP::UserAgent=>q[0], HTTP::Response=>q[0], MIME::Base64=>q[0], Mouse=>q[0], Digest::SHA=>q[0], JSON=>q[0], Mouse::Util::TypeConstraints=>q[0] }
#     VERSION_FROM => q[lib/Net/CloudStack.pm]
#     clean => { FILES=>q[Net-CloudStack-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/CloudStack.pm
...
TO_INST_PM = lib/Net/CloudStack.pm

PM_TO_BLIB = lib/Net/CloudStack.pm \
...
DISTNAME = Net-CloudStack
DISTVNAME = Net-CloudStack-0.01001
...
manifypods : pure_all  \
	lib/Net/CloudStack.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Net/CloudStack.pm $(INST_MAN3DIR)/Net::CloudStack.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: "Bindings for the CloudStack API\r"' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Shugo Numano <numano@cc.rim.or.jp>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Net-CloudStack' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Mouse::Util::TypeConstraints: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::More: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  URI::Encode: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  XML::Simple: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  XML::Twig: 0' >> META_new.yml
	$(NOECHO) $(ECHO) 'version: 0.01001' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "Bindings for the CloudStack API\r",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Shugo Numano <numano@cc.rim.or.jp>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Net-CloudStack",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Mouse::Util::TypeConstraints" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "Test::More" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "URI::Encode" : 0,' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   "version" : "0.01001"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.01001">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Bindings for the CloudStack API</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Shugo Numano &lt;numano@cc.rim.or.jp&gt;</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="HTTP::Response" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Mouse::Util::TypeConstraints" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Net/CloudStack.pm blib/lib/Net/CloudStack.pm 
