...
DISTVNAME = Net-CloudStack-0.01003
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: 0.01003' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : "0.01003"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.01003">' > $(DISTNAME).ppd
